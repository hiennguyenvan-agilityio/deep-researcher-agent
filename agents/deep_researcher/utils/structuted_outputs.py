...
class GatekeeperOutput(TypedDict):
    ...
    """
    action: Annotated[Literal["refuse", "ask_user", "proceed"] , "The decision after safety and clarity checks."]
    message: Annotated[Optional[str], "Refusal message, clarification questions or clarified query to show to the user, None if proceed."]
    query: Annotated[Optional[str], "If proceed, the fully clarified query to pass to planner."]